...
JoystickView = Backbone.View.extend({
    ...
    initialize: function(squareSize, finishedLoadCallback){
        ...
        this.sprite = loadSprite(BASE_DIR + "static/control/img/button.png", function(){
            self.joyStickLoaded = true;
            self._tryCallback();
        });
        this.background = loadSprite(BASE_DIR + "static/control/img/canvas.png", function(){
